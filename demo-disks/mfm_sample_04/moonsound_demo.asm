...
MoonSound_tabl_music:
		...
		db	13h   				; 2 музыкальное произведение
		dw	0C000h
		dw	31B0h
		...
		db	14h   				; 4 музыкальное произведение
		dw	0C000h
		dw	3180h

		db	16h   				; 5 музыкальное произведение
		dw	0C000h
		dw	3350h

		db	17h   				; 6 музыкальное произведение
		dw	0C000h
		dw	1250h
		db	17h   				; 7 музыкальное произведение
		dw	0D250h
		dw	1540h
		db	17h   				; 8 музыкальное произведение
		dw	0E790h
		dw	1130h
