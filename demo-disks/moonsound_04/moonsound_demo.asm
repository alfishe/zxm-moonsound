...
MoonSound_load:
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим DREAMER.MWM
		ld	de,(5CF4h)
		ld	bc,1C05h
		call	3d13h
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим DREAMTHI.MWM
		ld	de,(5CF4h)
		ld	bc,1405h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим KNOWNEED.MWM
		ld	de,(5CF4h)
		ld	bc,1305h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим MILKMAN.MWM
		ld	de,(5CF4h)
		ld	bc,0F05h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим MIRROR.MWM
		ld	de,(5CF4h)
		ld	bc,1005h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим SPRING.MWM
		ld	de,(5CF4h)
		ld	bc,1505h
		call	3d13h
		call	MoonSound_mwmload
