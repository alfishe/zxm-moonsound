...
MoonSound_load:
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим BONGIE.MWM
		ld	de,(5CF4h)
		ld	bc,1305h
		call	3d13h
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим JOINTEE.MWM
		ld	de,(5CF4h)
		ld	bc,0705h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим PUMPING.MWM
		ld	de,(5CF4h)
		ld	bc,1205h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим REMEMBER.MWM
		ld	de,(5CF4h)
		ld	bc,0D05h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим SACRIFIC.MWM
		ld	de,(5CF4h)
		ld	bc,2105h
		call	3d13h
		call	MoonSound_mwmload
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0D000h			;грузим WILLWIND.MWM
		ld	de,(5CF4h)
		ld	bc,2105h
		call	3d13h
		call	MoonSound_mwmload
