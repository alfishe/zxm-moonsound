...
MoonSound_load_0:
		...
		ld	a,(MoonSound_memory_128)
		and	a
		jr	z,MoonSound_load_1

		ld	a,90h 
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0C000h			;грузим анимацию
		ld	de,(5CF4h)
		ld	bc,2B05h
		call	3d13h
		call	Animation_init
...
MoonSound_end:
		...
		.include  cat_data.asm
		.savebin "catdata.bin",CatPoison_phase_000, CatPoison_end - CatPoison_phase_000
