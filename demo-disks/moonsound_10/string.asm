...
Str_addr_text:
		...
		db 	'                опхбер, опхбер! ноърэ бюя рпебнфхр мюднедкхбши окчьебши ледбедэ - MICK !'
		db	' унвс опедярюбхрэ еые ндхм ябефхи яанпмхй йпюяхбшу х ме нвемэ лекндхи дкъ гбсйнбни йюпрш *ZXM-MOONSOUND*.'
		db	' оняйнкэйс опедшдсыли бшосяй бшьек оюпс дмеи мюгюд, рн дюфе апедю янвхмхрэ опнакелюрхвмн,'
		db	' ябефхе лшякх еые ме мюярнъкхяэ, ю б нярюкэмнл бяе йюй нашвмн, нвепедмюъ онпжхъ тюикнб я пюяьхпемхел MWM, йнрнпше ме рпеасчр гюцпсгйх'
		db	' ящлокнб. йюпрхмйю хг хмерю, якецйю яйнмбепвемю х ондпхурнбюмю б лепс лнху слемхи.'
		db	' хг мнбьеярбю лнцс нрлерхрэ рн, врн реоепэ лекндхх ме гюжхйкхбючряъ он нйнмвюмхч, ю оепеундър мю опнхцпшбюмхе'
		db	' якедсчыеи. бопнвел он ймнойе SPACE лнфмн сяйнпхрэ опнжеяя оепейкчвемхъ. щрн ашкн ядекюмн он опняэае'
		db	' яксьюрекеи, хл онмхлюеьэ кемхбн ймнойс мюфхлюрэ, ьсрйю :)'  
		...
		db	' HANNOBET.MWM (HANNO BETAALT - MOONSOUND IS EEN DOMME NAAM - MEITS),'
		db	' MAG10_12.MWM (BLOWING YOUR MIND - E VD HEIDE),'
		db	' FANTASYS.MWM (SAME FANTASY - MEITS 1996),'
		db	' MAG10_15.MWM (ATMOSPHERIC JOURNEY - E VD HEIDE 1996),'
		db	' MAG10_17.MWM (CHORDS - E VD HEIDE),'
		db	' MAG7_2.MWM (THE SEVENTH COLLECTION - E VD HEIDE),'
		db	' BEACH.MWM (TOGETHER ON THE BEACH - MEITS 1996),'
		db	' M_GEAR.MWM (MEITSELGEAR (1) - (C) Meits 1993/94/95/96),'
		db	' RAVE1.MWM (RAVE PIANO #1 - MASTER OF AUDIO),'
		db	' MAG8_14.MWM (THE FEELING - E VD HEIDE),'
		db	' QLSZMMZ.MWM (69 STIEM  QLSZMMZ  OLEV R),'
		db	' SELECTOR.MWM (MAKE UP YER MIND - OPL4 VERSION - SOUNDWAVE 1997).'
